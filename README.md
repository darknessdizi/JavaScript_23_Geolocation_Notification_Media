...
[![Build status](https://ci.appveyor.com/api/projects/status/6yv514bulorttehs?svg=true)](https://ci.appveyor.com/project/darknessdizi/javascript-23-geolocation-notification-media)

Ссылка на страницу: https://darknessdizi.github.io/JavaScript_23_Geolocation_Notification_Media/
